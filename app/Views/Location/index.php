            ...
            <div class="container">
                <div>
                                    ...
                                    <tbody class="table table-bordered">
                                        <?php foreach ($location as $l) : ?>
                                            <tr>
                                                ...
                                                <td><?= $l->name ?></td>
                                                <td>
                                                    <div class="btn-custom" role="group" aria-label="Basic example" style="display: flex;width: 1rem;">
                                                        <a href="<?= base_url() ?>location/view/<?= $l->id ?>" class="btn" style="margin-right: 3px;">View</a>
                                                        <a href="<?= base_url() ?>location/edit/<?= $l->id ?>" class="btn" style="margin-right: 3px;">Edit</a>
                                                        <form action="<?= base_url() ?>location/<?= $l->id ?>" method="post" onsubmit="return confirm('Are you sure you want to delete location?')">
                    ...
                    <div class="sidebar-btn" style="bottom: 20px; left: 2rem;">
                        <a href="<?= base_url() ?>location/add/" class="btn btn-success" style="margin-bottom: 0; display: flex; align-items: center; margin-right: 66rem; width: 9.6rem;">
                            <i class="material-symbols-outlined" style="margin-right: 0.5rem;">add</i> Add Location
                        </a>
                    </div>
