            ...
            <div class="container">
                <div>
                                    ...
                                    <tbody class="table table-bordered">
                                        <?php foreach ($department as $dp) : ?>
                                            <tr>
                                                ...
                                                <td><?= $dp->name ?></td>
                                                <td>
                                                    <div class="btn-custom" role="group" aria-label="Basic example" style="width: 4.4rem;display: flex;">
                                                        <a href="<?= base_url() ?>department/view/<?= $dp->id ?>" class="btn" style="margin-right: 3px;">View</a>
                                                        <a href="<?= base_url() ?>department/edit/<?= $dp->id ?>" class="btn" style="margin-right: 3px;">Edit</a>
                                                        <form action="<?= base_url() ?>department/<?= $dp->id ?>" method="post" onsubmit="return confirm('Are you sure you want to delete department?')">
                    ...
                    <div class="sidebar-btn" style="bottom: 20px; left: 2rem;">
                        <a href="<?= base_url() ?>department/add/" class="btn btn-success" style="margin-bottom: 0; display: flex; align-items: center; margin-right: 66rem; width: 11.5rem;">
                            <i class="material-symbols-outlined" style="margin-right: 0.5rem;">add</i> Add Department
                        </a>
                    </div>
