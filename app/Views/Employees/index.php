            ...
            <div class="container">
                <div>
                                    ...
                                    <tbody class="table table-bordered">
                                        <?php foreach ($employees as $user) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-custom" role="group" aria-label="Basic example" style="display: flex;">

                                                        <a href="<?= base_url() ?>employees/view/<?= $user->id ?>" class="btn" style="margin-right: 3px;">View</a>
                                                        <a href="<?= base_url() ?>employees/edit/<?= $user->id ?>" class="btn" style="margin-right: 3px;">Edit</a>
                                                        <form action="<?= base_url() ?>employees/<?= $user->id ?>" method="post" onsubmit="return confirm('Are you sure you want to delete employee?')">
                    ...
                    <div class="sidebar-btn" style="bottom: 20px; left: 2rem;">
                        <a href="<?= base_url() ?>employees/add/" class="btn btn-success" style="margin-bottom: 0; display: flex; align-items: center; margin-right: 66rem; width: 10.5rem;">
                            <i class="material-symbols-outlined" style="margin-right: 0.5rem;">add</i> Add Employee
                        </a>
                    </div>
                </div>
            </div>
