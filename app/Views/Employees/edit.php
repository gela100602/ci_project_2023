  ...
  <div class="employees">
    ...
    <div class="content-area" style="width: 100%; max-height: 700px;">
      ...
      <div class="container-fluid" style="margin-left: -0.7rem;">
        <form action="<?= base_url() ?>employees/edit/<?= $employees->id ?>" method="post">
          <div class="row">
            <div class="col-lg-3">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <div class="form-group row" style="padding-bottom: 0.5rem;">
                      ...
                      <div class="col p-0">
                        <input type="text" class="form-control" id="full_name" name="full_name" value="<?= $employees->full_name?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row" style="padding-bottom: 0.5rem;">
                      ...
                      <div class="col p-0">
                        <input type="text" class="form-control" id="contact_number" name="contact_number" value="<?= $employees->contact_number ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row" style="padding-bottom: 0.5rem;">
                      ...
                      <div class="col p-0">
                        <input type="int" class="form-control" id="age" name="age" value="<?= $employees->age ?>">
                      </div>
                    </div>
                    ...
                    <div class="form-group row" style="padding-bottom: 0.5rem;">
                      ...
                      <div class="col-lg p-0">
                        <input type="date" class="form-control col-lg" name="birth_date" id="birth_date" min="1990-01-01" value="<?= $employees->birth_date ?>">
                      </div>
                    </div>
                  ...
                  <div class="col-lg-6" style="padding-left: 1.75rem; padding-right: 2.5rem;">
                    ...
                    <div class="form-group row" style="padding-bottom: 0.5rem;">
                      ...
                      <div class="col-lg p-0">
                        <input type="date" class="form-control col-lg" name="hire_date" id="hire_date" min="2004-04-16" max="<?= date('Y-m-d', time()); ?>" value="<?= $employees->hire_date ?>">
                      </div>
                    </div>
                  </div>
                </div>
